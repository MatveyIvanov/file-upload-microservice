...
PROD: bool = bool(int(os.environ.get("PROD", 1)))

LOGGING_MAX_BYTES: int = int(os.environ.get("LOGGING_MAX_BYTES", 1024 * 3))
LOGGING_BACKUP_COUNT: int = int(os.environ.get("LOGGING_BACKUP_COUNT", 1))
